...
class Activities(Base):
    ...
    mood_activities: Mapped[List['MoodActivities']] = relationship('MoodActivities', back_populates='activities')
...
class Emotions(Base):
    ...
    mood_emotions: Mapped[List['MoodEmotions']] = relationship('MoodEmotions', back_populates='emotion')
...
class Mood(Base):
    ...
    mood_activities: Mapped[List['MoodActivities']] = relationship('MoodActivities', back_populates='mood')
    mood_emotions: Mapped[List['MoodEmotions']] = relationship('MoodEmotions', back_populates='mood')
...
class MoodActivities(Base):
    ...
    activities: Mapped['Activities'] = relationship('Activities', back_populates='mood_activities')
...
class MoodEmotions(Base):
    ...
    emotion: Mapped['Emotions'] = relationship('Emotions', back_populates='mood_emotions')
